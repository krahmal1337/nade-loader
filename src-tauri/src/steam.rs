...
#[cfg(windows)]
pub fn inject_dll(pid: u32, dll_path: &str) -> Result<(), LauncherError> {
    eprintln!("[inject] opening PID {pid} for injection");
...
#[cfg(not(windows))]
pub fn inject_dll(_pid: u32, _dll_path: &str) -> Result<(), LauncherError> {
